...
export default function Register() {
  ...
  return (
    <div className="container flex justify-center items-center h-full animate-fade-in" style={{ minHeight: 'calc(100vh - 64px)' }}>
      <div className="glass" style={{ padding: '40px', borderRadius: '16px', width: '100%', maxWidth: '400px' }}>
        <h2 className="text-center" style={{ marginBottom: '24px' }}>Create an Account</h2>
        <form onSubmit={handleSubmit} className="flex-col gap-4">
          ...
          <div className="control-group">
            <label className="control-label">How did you find this app?</label>
            <input type="text" value={source} onChange={e => setSource(e.target.value)} placeholder="e.g. Google, Friend, Twitter" />
          </div>
          <button type="submit" className="primary w-full" style={{ marginTop: '16px' }}>Sign Up</button>
        </form>
        ...
        <button onClick={handleGoogleLogin} className="secondary w-full hover-glow" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px' }}>
        ...
        <p className="text-center text-muted text-sm" style={{ marginTop: '24px' }}>
